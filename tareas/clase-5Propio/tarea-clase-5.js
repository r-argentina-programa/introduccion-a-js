...
function calcularSalarioMensual(n1) {
  const MONTHS_IN_YEAR = 12
  return n1 / MONTHS_IN_YEAR
}

const $BOTON_INGRESO = document.querySelector('#boton-usuario');

$BOTON_INGRESO.onclick = function () {

  const $SALARIO_USUARIO = document.querySelector('#salario-usuario').value
  const salarioAnual = calcularSalarioMensual($SALARIO_USUARIO)

  document.querySelector('#resultado').value = salarioAnual
