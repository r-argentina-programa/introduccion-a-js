...
$botonIngreso.onclick = function() {
  ...
  let salarioMensualUsuario = document.querySelector("#salario-mensual-usuario");
  salarioMensualUsuario.value = `Salario mensual: ${salarioAnualUsuario / mesesEnUnAño} pesos.`;
