...
/*
const btn = document.querySelector("#btn_salario")
btn.onclick = function(){
  const salarioAnual = document.querySelector("#salario_anual").value
  const salarioMensual = document.querySelector("#salario_mensual")
  salarioMensual.value = "Tu sueldo mensual es: " + (salarioAnual/12).toFixed(2)
}
*/
