...
// const TEMPERATURA_EN_CELCIUS = 70;
...
// console.log(convertirCelciusAFahrenheit(TEMPERATURA_EN_CELCIUS));

// Desafío de programación #9: Crea una función que convierta de Fahrenheit a Celsius

// const TEMPERATURA_EN_FAHRENHEIT = 70;

// function convertirFahrenheitACelcius(fahrenheit) {
//     const celcius = (fahrenheit - 32) / 1.8;
//     return celcius;
// }

// console.log(convertirFahrenheitACelcius(TEMPERATURA_EN_FAHRENHEIT));

// Desafío de programación #10: Calcula la suma de todos los números en un array de números

// const array = [1,5,7,9,9,5,4,3];
// let resultado = 0;
...
// const arrayPrueba = [3,5,6];

// console.log(calcularPromedioArray(arrayPrueba));

// Desafío de programación #12: Crea una función que reciba un array de números y devuelva un array conteniendo solo los números positivos

// const arrayPrueba = [5, -5, -20, 6, 100, -100];

// function devolverNumeroPositivoEnArray(array) {
...
// console.log(devolverNumeroPositivoEnArray(arrayPrueba));

// Desafío de programación #13: Find the maximum number in an array of numbers

// const arrayPrueba = [5, 100, 6, -1, 454, 2, 500];

// function devolverMaxNumEnArray(array) {
//   let contenedor = 0;

//   for (i = 0; i < array.length; i++) {
//     if (array[i] > contenedor) {
//       contenedor = array[i];
//     }
//   }
...
// console.log(devolverMaxNumEnArray(arrayPrueba));
...
if (arrayNumeros.length > arrayLetras.length) {
  index = arrayNumeros.length;
} else {
  index = arrayLetras.length;
}


for (i = 0; i < index; i++) {

  if (arrayNumeros.length > i) {
    nuevoArray.push(arrayNumeros[i])
  }
  
  if (arrayLetras.length > i) {
    nuevoArray.push(arrayLetras[i]);
  }
