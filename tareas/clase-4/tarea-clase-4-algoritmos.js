...
console.log(sumaDeNumeros(numeros));
...
function sumaMayor10Menor30() {
  let suma = 0;
  for (i = 11; i <= 30; i = i + 2) {
    suma = suma + i;
  }
}
console.log(sumaMayor10Menor30);

/*
Desafío de programación #8: Crea una función que convierta de Celsius a Fahrenheit
*/
function CelsiusAFahrentheit(celsius) {
  const fahrenheit = (celsius * 9) / 5 + 32;
  return fahrenheit;
}

console.log(`${CelsiusAFahrentheit(17)}°F`);
/*
...
console.log(`${FahrenheitACelsius(34)}°C`);
/*
...
*/
let arrayNotas = [1, 2, 3, 4, 5, 6, 7, 8, 9];

function promedioArray(arrayNotas) {
  let suma = 0;
  for (i = 0; i < arrayNotas.length; i = i + 1) {
    suma = suma + arrayNotas[i];
  }
  console.log(
    `El promedio de la suma de ${arrayNotas} es ${suma / arrayNotas.length}`
  );
}

promedioArray(arrayNotas);

/*
Desafío de programación #12: Crea una función que reciba un array de números y devuelva un array conteniendo solo los números positivos
*/

let arrayNumerosPyN = [1, 9, -99, -8, 100, -77, 88, 77];

function numerosPositivos(arrayNumerosPyN) {
  let arrayPositivos = [];
  for (i = 0; i < arrayNumerosPyN.length; i = i + 1) {
    if (arrayNumerosPyN[i] >= 0) {
      arrayPositivos.push(arrayNumerosPyN[i]);
    }
  }
  return arrayPositivos;
}

console.log(numerosPositivos(arrayNumerosPyN));

/*
Desafío de programación #13: Find the maximum number in an array of numbers
*/

const numeros = [1, 2, 88, 23, 231, 3254, 131];

function mayorNumero(numeros) {
  let numeroMaximo = 0;
  for (i = 0; i < numeros.length; i = i + 1) {
    if (numeroMaximo < numeros[i]) numeroMaximo = numeros[i];
  }

  return numeroMaximo;
}

console.log(`El maximo numero es ${mayorNumero(numeros)}`);
