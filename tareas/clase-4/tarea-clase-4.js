...
for (let i = 1; i <=50; i++) {  //FizzBuzz clasico
    if(i%3 === 0 && i%5 ===0){
...
/*  function calcularPromedio(numeros) {//Para que sea una funcaion mas general
    let total = 0;
...
function verificarEdadEntrada(edad = 18){//esto es un parametro por default
    if(edad >= 18 ){
...
el sigo de pregfuna ? es como decir if = if(edad >= 18)
...
let z = function(p1){//Funcion anonima
    console.log(p1);
