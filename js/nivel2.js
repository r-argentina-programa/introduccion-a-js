...
/*
let comidasFavoritas = ['pizza', 'empanadas', 'milanesa', 'paella']
...
/*
let comidasFavoritas = ['pizza', 'empanadas', 'milanesa', 'paella'].length
console.log(comidasFavoritas)
*/
...
//const danzas = ['gato', 'chacarera', 'escondido']
//danzas.push('carnavalito')
//danzas[1] = 'carnaval'
//danzas = ['Huayra', 'doble', 'salamanca'] 
//console.log(danzas)
...
/*
let comidasFavoritas = ['Pizzas', 'Empanadas', 'MIlanesas', 'Fideos con salsa']
for (let i = 0; i < comidasFavoritas.length; i++){
    console.log("Me gusta l@s " + comidasFavoritas[i])
}
*/
