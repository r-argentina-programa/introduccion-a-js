...
/*
let juegosFavoritos = ["COD MW", "Detroit Become Human", "The Witcher 3", "Warcraft 3"];

for(i=0; i < juegosFavoritos.length ; i++){
 
    if( i === 1){
        console.log("Hi, my name is Connor, I'm the android send by CiberLife");
        console.log("Si, hablo del " + juegosFavoritos[i]);
    }else{
        console.log("Me gusta el " + juegosFavoritos[i]);
    }
}
