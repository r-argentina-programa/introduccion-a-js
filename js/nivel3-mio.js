...
const imagenIndex = document.querySelector("img");
console.log(imagenIndex);
imagenIndex.src = "img/kittens.jpeg";
...
nuestroTitulo.style.color = "indigo";
const nuestroSubtitulo = document.querySelector("h2");
nuestroSubtitulo.style.color = "peru";
/*
...
const posicionImagen = document.querySelector("#logo");
posicionImagen.appendChild(nuevaImagen);
...
const nombreUsuario = Number(document.querySelector("#nombre-usuario").value);
