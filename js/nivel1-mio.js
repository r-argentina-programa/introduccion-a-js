...
/* let edadUsuario = prompt("Por favor, ingrese su edad", 10);
function saludar(nombre) {
	return `Hola ${nombre}!`;
}

let nombre2 = prompt("Igresá tu nombre!");
// console.log(saludar(nombre2));

function edadUsuariov2(anioNacimiento, anioActual) {
	return anioActual - anioNacimiento;
}

let anioActual = prompt("Ingresá el año actual");
let anioNacimiento = prompt("Ingresá el año en el que naciste"); */

// console.log(edadUsuariov2(anioNacimiento, anioActual));
...
const operadorMatematico = prompt("Ingresá un operador matemático");
const valor1 = 15;
const valor2 = 5;
...
if (operadorMatematico === "+") {
	...
	console.log(`No entiendo el operador ${operadorMatematico}`);
}

console.log(`El resultado de ${valor1} ${operadorMatematico} ${valor2} es ${resultado}`);
