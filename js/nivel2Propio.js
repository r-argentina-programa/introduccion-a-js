...
//       cosas que te gustan.
/*
const comidasFavoritas = ['milanesa', 'fideos', 'pizza', 'guiso'];
*/
/*
    Tamaño del Array
    ================
...
/*
const mascotas = ['gato', 'perro', 'tortuga']
mascotas[2] = 'perro'
...
*/
/*
const notasParciales = [9,3,6,5]
let notasPromedio = 0;

for (i=0; i<notasParciales.length; i++){
    notasPromedio = notasPromedio + notasParciales[i]
}

console.log(`tu promedio es de ${notasPromedio / notasParciales.length}`)
*/
...
/*
let cantidadParciales = prompt(`Cuantas notas de parciales son?`)
let promedioExamenes = 0
let notasExamenes = []
for (i = 0; i < cantidadParciales; i++) {
    notasExamenes.push(prompt(`Ingresa tus notas`))
}

const DATOS_USUARIO = [cantidadParciales, promedioExamenes, notasExamenes]

function calcularPromedio(DATOS_USUARIO) {
    for (i = 0; i < cantidadParciales; i++) {
        promedioExamenes = promedioExamenes + notasExamenes[i]
    }
    console.log(`tu promedio es de ${promedioExamenes / notasExamenes.length}`)
}

calcularPromedio(DATOS_USUARIO)
*/
/*
