...
// console.log("el nombre de la variable es " + variable1)

// let name = "Fabrizio"
// console.log("Mi nommbre es " + name)
...
//  const edadUsuario = calcularEdadUsuario(anioNacimiento, anioActual)

//  alert("Tu edad es " + edadUsuario + " años");

//  function calcularSalarioAnual (salarioMensual){
//      const totalSalariosAnuales = 13;
//      return salarioMensual * totalSalariosAnuales;
//  }

//  const salarioMensual = Number(prompt("Cual es tu sueldo mensual en USD?"));

//  const SalarioAnual= Number(calcularSalarioAnual(salarioMensual));

//  alert("Tu sueldo anual es de " + SalarioAnual + " Dolares")
/*
...
// let resultado;
// const operator = prompt("Ingresa un operador aritmético (+, -, *, /");
// const numero1 = Number(prompt("Elegí un número!"));
// const numero2 = Number(prompt("Elegí otro número!"));
...
// alert("El resultado de " + numero1 + operator + numero2 + " es " + resultado);
...
// } else {
//   alert("Error");
//   resultado = "No existe el operador aritmético";
// }
...
let elPesoEsEstable = true;
console.log(!elPesoEsEstable);
