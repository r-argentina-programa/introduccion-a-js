...
function titulo() {
    ...
    nuestroTitulo.innerText = 'NUEVO TITULO'
}
// titulo()
...
document.querySelector('h1').textContent = 'Hola, esto es un nuevo titulo'
...
let imagenLogo = document.querySelector('img')
imagenLogo.src = 'img/kittens.jpeg'
...
const headerCambiarEstilo = document.querySelector('header');
headerCambiarEstilo.style.backgroundColor = 'red'
...
const nodoPagina = document.querySelector('header'); //DECLARAR VARIABLE AL HEADER
const nuevoParrafo = document.createElement('p'); //CREAS NUEVO ELEMENTO
const textoParrafo = document.createTextNode('YEEET'); //CREAS UN TEXTO 
nuevoParrafo.appendChild(textoParrafo); // ANEXAS EL TEXTO AL ELEMENTO
nodoPagina.appendChild(nuevoParrafo); // ANEXAS EL ELEMENTO AL HEADER
nuevoParrafo.style.backgroundColor = 'orange'
nuevoParrafo.style.fontSize = '25px'

//INTENTO MIO

const logoParrafo = document.createElement('img'); // NUEVO ELEMENTO
nodoPagina.appendChild(logoParrafo); // ANEXAS EL ELEMENTO AL HEADER
logoParrafo.srcset = "img/woman_bw.jpg"
logoParrafo.style.backgroundColor = 'white'
